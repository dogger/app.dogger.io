...
{
    [TestClass]
    public class DeletePullDogRepositoryByGitHubInstallationIdCommandTest
    {
        [TestMethod]
        ...
        public async Task Handle_PullDogRepositoryWithPullRequestPresentInDatabase_DeletesBothRepositoryAndPullRequests()
        {
            ...
            //Act
            await environment.Mediator.Send(new DeletePullDogRepositoryByGitHubInstallationIdCommand(1337));
