...
using Dogger.Domain.Controllers.PullDog.Api;
...
using NSubstitute;
using Octokit;
using RepositoriesResponse = Dogger.Domain.Controllers.PullDog.Api.RepositoriesResponse;

namespace Dogger.Tests.Domain.Controllers.PullDog
{
    [TestClass]
