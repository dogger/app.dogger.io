...
namespace Dogger.Migrations
{
    ...
    [Migration("20200427193812_DockerComposeYmlNullable")]
    partial class DockerComposeYmlNullable
    {
            ...
            modelBuilder.Entity("Dogger.Domain.Models.Instance", b =>
                {
                    ...
                    b.Property<string>("PullDogPullRequestHandle")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("PullDogRepositoryId");
            ...
            modelBuilder.Entity("Dogger.Domain.Models.PullDogRepository", b =>
                {
                    ...
                    b.Property<string>("DockerComposeYmlFilePaths")
                        .HasColumnType("nvarchar(max)");
