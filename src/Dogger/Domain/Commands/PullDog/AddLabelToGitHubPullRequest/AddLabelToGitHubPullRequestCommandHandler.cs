...
{
    public class AddLabelToGitHubPullRequestCommandHandler : IRequestHandler<AddLabelToGitHubPullRequestCommand, Unit>
    {
        private readonly IGitHubClientFactory gitHubClientFactory;

        public AddLabelToGitHubPullRequestCommandHandler(
        ...
        public async Task<Unit> Handle(
            AddLabelToGitHubPullRequestCommand request,
            CancellationToken cancellationToken)
        {
            ...
            await client
                .Issue
                .Labels
                .AddToIssue(repositoryId, pullRequestNumber, new[]
                {
                    request.Label
                });
